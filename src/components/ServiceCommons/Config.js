...
export const config = {
	...
	linkSeguidores: `${process.env.REACT_APP_WHATSAPP}?phone=${'56997104052'}&text=Hola, vi su anuncio de cuentas virales y quisiera conocer el método para crecer en instagram`,
